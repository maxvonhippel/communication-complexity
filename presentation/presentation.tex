...
\include{introduction/intro1}
\end{frame}

\begin{frame}{Introduction (Max)}
\include{introduction/intro2}
\end{frame}

\begin{frame}{Introduction (Max)}
\include{introduction/intro3}
\end{frame}

\begin{frame}{Introduction (Max)}
\include{introduction/intro4}
\end{frame}

\subsection{Examples}

\begin{frame}{Parity (Jake)}
\include{examples/parity}
\end{frame}

\begin{frame}{Halting (Jake)}
\include{examples/halting}
\end{frame}
...
\include{introduction/bounds}
\end{frame}

\subsubsection{Fooling Set Method}

\begin{frame}{Fooling Set Method (Jake)}
\include{foolingset/fs0}
\end{frame}

\begin{frame}{Fooling Set Method (Jake)}
\include{foolingset/fs1}
\end{frame}

\begin{frame}{Fooling Set Method (Jake)}
\include{foolingset/fs2}
\end{frame}

\begin{frame}{Fooling Set Method (Jake)}
\include{foolingset/fs4}
\end{frame}

\begin{frame}{Fooling Set Method (Jake)}
\include{foolingset/fs3}
\end{frame}
...
\include{twopdisc/tpd-overview}
\end{frame}

\begin{frame}{2-Party Discrepency Method (Max)}
\include{twopdisc/tpd1}
\end{frame}

\begin{frame}{2-Party Discrepency Method (Max)}
\include{twopdisc/tpd2}
\end{frame}

\begin{frame}{2-Party Discrepency Method (Max)}
\include{twopdisc/tpd3}
\end{frame}

\begin{frame}{2-Party Discrepency Method (Max)}
\include{twopdisc/tpd4}
\end{frame}

\subsection{Multi-Party Problem}

\begin{frame}{Multi-Party Problem (Jake)}
\include{multiparty/mp1}
\end{frame}

\begin{frame}{Multi-Party Problem (Jake)}
\include{multiparty/mp2}
\end{frame}

\begin{frame}{Multi-Party Problem (Jake)}
\include{multiparty/cyl}
\end{frame}
...
\include{random/rand1}
\end{frame}

\begin{frame}{Randomized (Max)}
\include{random/rand2}
\end{frame}

\begin{frame}{Randomized (Max)}
\include{random/rand-coin}
\end{frame}
